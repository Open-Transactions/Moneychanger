...
//        const QString qstrAgreementId      = lAgreementId > 0 ? QString::fromStdString(Moneychanger::It()->OT().Exec().LongToString(lAgreementId)) : "";
//        const QString qstrReceiptId        = lReceiptId > 0 ? QString::fromStdString(Moneychanger::It()->OT().Exec().LongToString(lReceiptId)) : "";
