...
//        const QString qstrTxnId            = lTxnId        > 0 ? QString::fromStdString(Moneychanger::It()->OT().Exec().LongToString(lTxnId       )) : "";
//        const QString qstrTxnIdDisplay     = lTxnIdDisplay > 0 ? QString::fromStdString(Moneychanger::It()->OT().Exec().LongToString(lTxnIdDisplay)) : "";
...
//                ? QString("")
//                : QString::fromStdString(Moneychanger::It()->OT().Exec().GetServer_Name(qstrMsgNotaryID.toStdString()));

//            const QString qstrPmntNotaryName = qstrPmntNotaryID.isEmpty()
//                ? QString("")
//                : QString::fromStdString(Moneychanger::It()->OT().Exec().GetServer_Name(qstrPmntNotaryID.toStdString()));

//            const QString qstrMyAcctName = qstrMyAcct.isEmpty()
//                ? QString("")
//                : QString::fromStdString(Moneychanger::It()->OT().Exec().GetAccountWallet_Name(qstrMyAcct.toStdString()));

//            const QString qstrAssetName = qstrAssetType.isEmpty()
//                ? QString("")
//                : QString::fromStdString(Moneychanger::It()->OT().Exec().GetAssetType_Name(qstrAssetType.toStdString()));
