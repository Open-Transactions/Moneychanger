...
static const char qt_meta_stringdata_QJsonRpcServiceReply[] = {
    "QJsonRpcServiceReply\0\0finished()\0"
};
...
const QMetaObjectExtraData QJsonRpcServiceReply::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QJsonRpcServiceReply::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QJsonRpcServiceReply,
      qt_meta_data_QJsonRpcServiceReply, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QJsonRpcServiceReply::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QJsonRpcServiceReply))
