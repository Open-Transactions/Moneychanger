    ...
    ui(new Ui::DlgGetAmount)
{
    ...
    // ----------------------
    std::string str_asset_name  = opentxs::OTAPI_Wrap::Exec()->GetAssetType_Name(qstrInstrumentDefinitionID.toStdString());
    ...
    std::string str_acct_name = opentxs::OTAPI_Wrap::Exec()->GetAccountWallet_Name(qstrAcctId.toStdString());
    ...
    // ----------------------
    std::string str_amount = opentxs::OTAPI_Wrap::Exec()->FormatAmount(m_qstrInstrumentDefinitionID.toStdString(), m_lAmount);
    // ----------------------
...
void DlgGetAmount::on_lineEdit_editingFinished()
{
    ...
    m_lAmount   = opentxs::OTAPI_Wrap::Exec()->StringToAmount(m_qstrInstrumentDefinitionID.toStdString(), ui->lineEdit->text().toStdString());
    str_amount  = opentxs::OTAPI_Wrap::Exec()->FormatAmount  (m_qstrInstrumentDefinitionID.toStdString(), m_lAmount);
